...
#
# @example Fetch user data for notification
...
#   end
#
# @example Fetch doctor data for appointment notification
  ...
  class << self
    ...
    def build_headers(custom_headers)
      headers = {
        ...
        "User-Agent" => "MediConnect-NotificationsService/1.0"
      }
      ...
      headers["X-Internal-Service"] = "notifications-service"
