...
# SimpleCov Configuration for appointments-service
...
SimpleCov.start "rails" do
  ...
  command_name "appointments-service"
  ...
  # Exclude infrastructure/utility classes with legitimate lower coverage
  add_filter "app/services/event_publisher.rb"
